...
export default defineWebPackage((host) => () => {
  const off = [
    ...
    host.surfaces.register({ id: "git", title: "Source control", description: "Review and manage changes to the code.", shortLabel: "Git", capabilityId: "git", order: 2, component: GitView, presentation: { kind: "workspace", defaultRatio: 0.4, minWidth: 340, preferredMaxWidth: 640, keepAlive: true, escape: "close" } }),
