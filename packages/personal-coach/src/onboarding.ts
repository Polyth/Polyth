...
const WEEKLY_PROMPT = `This is a user-enabled Personal Coach weekly review. Call coach_read_context first. Review the durable goals, commitments, recent check-ins, reflections, and evidence that actually exist. Summarize what changed, what seems to be working, and what may need adjustment. Treat patterns as hypotheses. Any strategic goal, commitment, routine, or plan change you initiate must be created as a proposal for explicit user approval.`;
