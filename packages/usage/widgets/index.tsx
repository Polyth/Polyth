...
export default defineWebPackage((host) => () => {
  const off = [
    ...
    host.capabilities.register({ id: "usage", label: "Usage & cost", plainDescription: "See token, cost, and provider quota usage.", keywords: ["usage", "cost", "tokens", "quota"], standardTier: "more", standardRank: 15, open: () => host.navigation.openSettingsPage("usage"), available: () => true }),
  ];
