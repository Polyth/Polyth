...
export default defineWebPackage((host) => () => {
  const off = [
    host.workspaceSurfaces.register({ id: "github", title: "GitHub", description: "Browse issues and pull requests for this project.", order: 26, plugin: "github", requires: "project", component: () => createElement(GithubView) }),
