...
export default defineWebPackage((host) => () => {
  const off = [
    host.surfaces.register({ id: "browser", title: "Browser", description: "Preview and interact with a page alongside the conversation.", shortLabel: "Preview", capabilityId: "browser", order: 4, component: PreviewView, presentation: { kind: "workspace", defaultRatio: 0.45, minWidth: 380, preferredMaxWidth: 760, keepAlive: true, escape: "close" } }),
