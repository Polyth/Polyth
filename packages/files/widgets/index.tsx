...
export default defineWebPackage((host) => () => {
  const off = [
    host.surfaces.register({ id: "files", title: "Project files", shortLabel: "Files", capabilityId: "files", order: 1, component: EditorView, presentation: { kind: "workspace", defaultRatio: 0.6, minWidth: 380, preferredMaxWidth: 760, keepAlive: true, escape: "close" } }),
