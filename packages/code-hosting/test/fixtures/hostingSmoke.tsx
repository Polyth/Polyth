...
const gitlab={id:'gitlab',apiBase:'/api/gitlab',presentation:{serviceName:'GitLab',command:'glab',issueLabel:'Issue',changeLabel:'Merge request',changePlural:'Merge requests',changeNumberPrefix:'!',icon:()=>null},t:gitlabHostingText};
