...
export default defineWebPackage((host) => () => {
  const off = [
    host.surfaces.register({ id: "terminal", title: "Terminal", description: "Run commands in the project workspace.", capabilityId: "terminal", order: 3, component: TerminalView, presentation: { kind: "workspace", defaultRatio: 0.6, minWidth: 380, minHeight: 200, preferredMaxWidth: 760, keepAlive: true, escape: "content", dock: "bottom" } }),
