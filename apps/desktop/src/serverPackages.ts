...
export const desktopServerPackages = [
  ...
  entry("fusion", { name: "Fusion", description: "Synthesize multiple model responses.", core: false, enabled: false, settingsGroup: "Engineering", icon: "combine", hasSettings: false }, fusion),
  ...
  entry("knowledge", { name: "Knowledge", description: "Project notes, plans, and reusable context.", core: false, enabled: false, settingsGroup: "Workspace", icon: "knowledge", hasSettings: false }, knowledge),
  ...
  entry("multirun", { name: "Multirun", description: "Run prompts across multiple models.", core: false, enabled: false, settingsGroup: "Engineering", icon: "layers", hasSettings: false }, multirun),
  ...
  entry("walkthrough", { name: "Walkthrough", description: "Generate and review code walkthroughs.", core: false, enabled: false, settingsGroup: "Engineering", icon: "route", hasSettings: false }, walkthrough),
