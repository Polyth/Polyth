...
export const desktopServerPackages = [
  ...
  entry("walkthrough", { name: "Walkthrough", description: "Generate and review code walkthroughs.", core: false, enabled: true, settingsGroup: "Engineering", icon: "route", hasSettings: false, category: "workspace", projectAffinity: {} }, walkthrough),
