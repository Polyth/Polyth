...
const { resetDocsForTest } = await import("../src/editor/fileDocs.ts");
const { getEditorPrefs } = await import("../src/uiPrefs.ts");
const { default: FilePane } = await import("../src/components/editor/FilePane.tsx");
