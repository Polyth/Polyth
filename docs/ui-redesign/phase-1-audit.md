...
6. **Eight hand-rolled dialog surfaces** bypass `a11y/Dialog` (`Sidebar.tsx`, `SettingsView.tsx`,
   `ContextRail.tsx`, `ProjectSetup.tsx`, `Composer.tsx`, `CommandPalette.tsx`,
